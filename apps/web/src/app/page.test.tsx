...
describe("HomePage", () => {
  ...
  it("renders the GitHub-style discussion workbench", async () => {
    ...
    expect(fetchThreads).toHaveBeenCalledWith({ boardSlug: undefined, q: undefined, sort: "active", tag: undefined });
    ...
    expect(html).toContain("搜索标题、正文或作者...");
    expect(html).toContain("查看全部讨论");
    expect(html).toContain("后端开发");
    expect(html).toContain("/?boardSlug=backend");
