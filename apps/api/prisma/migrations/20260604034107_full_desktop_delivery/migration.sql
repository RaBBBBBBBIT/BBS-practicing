-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('COMMENT', 'REACTION', 'FOLLOW', 'REPORT', 'MODERATION', 'MESSAGE');

-- CreateEnum
CREATE TYPE "ReportTarget" AS ENUM ('THREAD', 'COMMENT');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SPAM', 'HARASSMENT', 'ILLEGAL', 'OTHER');
...
-- CreateIndex
CREATE UNIQUE INDEX "Reaction_threadId_userId_key" ON "Reaction"("threadId", "userId");
